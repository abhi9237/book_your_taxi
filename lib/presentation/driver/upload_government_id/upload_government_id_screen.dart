...
import 'package:book_your_taxi/controller/upload_government_id_controller.dart';
import 'package:book_your_taxi/core/color_constant/color_constant.dart';
import 'package:book_your_taxi/presentation/driver/upload_government_id/widget/upload_government_id_drop_zone.dart';
import 'package:book_your_taxi/presentation/driver/upload_government_id/widget/upload_government_id_guideline_item.dart';
import 'package:book_your_taxi/presentation/driver/upload_government_id/widget/upload_government_id_selected_file_card.dart';
import 'package:flutter/material.dart';
import 'package:get/get_state_manager/src/simple/get_state.dart';

class UploadGovernmentIdScreen extends StatelessWidget {
  const UploadGovernmentIdScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<UploadGovernmentIdController>(
      init: UploadGovernmentIdController(),
      builder: (controller) {
        return Scaffold(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const UploadGovernmentIdGuidelineItem(
                          text:
                        ...
                        UploadGovernmentIdDropZone(
                          onTap: () => _showPickerSheet(context, controller),
                        ),
                        const SizedBox(height: 20),
                        if (controller.selectedFile.value != null)
                          UploadGovernmentIdSelectedFileCard(
  ...
  void _showPickerSheet(
    ...
    UploadGovernmentIdController controller,
  ) {
